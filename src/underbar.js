(function() {
  ...
  _.last = function(array, n) {
    // if n is undefined, make it 1
    if (n === undefined) {n = 1;}
    // if n exceeds the maximum, make it the maximum
  ...
  _.uniq = function(array, hasIt, iterator) {
    var results = [];
    _.each(array, function(item) {
      if (!_.contains(results,item)) {results.push(item);}
    });
    return results;
  };
